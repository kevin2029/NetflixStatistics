...
class Printen_AlleProfielenVboxFlowpanaGelijkDataSet {

    @Test
    void alleProfielen() {

        //Arrange
        List<Map<String, Object>> verwachtResultaat = Connection.RunQuery("SELECT Profielnaam, Leeftijd\n" +
                "FROM Profiel;");

        //Act
        com.sun.javafx.application.PlatformImpl.startup(()->{});
        FlowPane test = Printen_AlleProfielen.AlleProfielen();
