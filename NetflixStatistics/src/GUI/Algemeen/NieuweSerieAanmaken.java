...
import Functionaliteit.Opslaan.Aanmaken.Opslaan_NieuweSerieAanmaken;
...
public class NieuweSerieAanmaken {

    public Scene NieuweSerieAanmaken(Stage stage){
        //Hier worden de grids aangemaakt.
        BorderPane Borderpane_SerieAanmaken=new BorderPane();
        ...
        //Hier wordt alles aan Borderpane_SerieAanmaken toegevoegd.
        Borderpane_SerieAanmaken.setTop(Hbox_Label);
        Borderpane_SerieAanmaken.setCenter(Vbox_Gegevens);

        //Hier wordt alles aan Hbox_Label toegevoegd.
        Hbox_Label.getChildren().add(Label_SerieAanmaken);
        ...
        //Hier wordt Borderpane_SerieAanmaken netjes gemaakt.
        Borderpane_SerieAanmaken.setStyle("-fx-background-color: #0A0A0A");

        //Hier wordt Hbox_Label netjes gemaakt.
        Hbox_Label.setAlignment(Pos.CENTER);
        Label_SerieAanmaken.setStyle("-fx-background-color: Black; -fx-text-fill: Red; -fx-font-size: 40");
        ...
        Scene NieuweSerieAanmaken=new Scene(Borderpane_SerieAanmaken,1300,650);
        stage.setTitle("Nieuwe serie aanmaken");
